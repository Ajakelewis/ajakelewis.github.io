...
<div class="row">
  <div class="leftcolumn">
    <div class="card">
      <h2>Blog 5</h2>
      <h5> April 1, 2021</h5>
     <p> Hi Lisa! We just got done with the second leg of our presentation which seemed to go pretty well. Now that we've completed project 0, we have begun our work to automate everything for Project 1 with Brent as our new Project leader. I hope we're able to get everything done in a reasonable time like the last project.   </p>
       <br>
